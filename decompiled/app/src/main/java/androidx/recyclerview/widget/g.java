...
public class g extends RecyclerView.y {
    ...
    public int t(View view, int i) {
        ...
        return s(pVarE.R(view) - ((ViewGroup.MarginLayoutParams) qVar).leftMargin, pVarE.U(view) + ((ViewGroup.MarginLayoutParams) qVar).rightMargin, pVarE.g0(), pVarE.r0() - pVarE.h0(), i);
    }
    ...
    public int u(View view, int i) {
        ...
        RecyclerView.q qVar = (RecyclerView.q) view.getLayoutParams();
        return s(pVarE.V(view) - ((ViewGroup.MarginLayoutParams) qVar).topMargin, pVarE.P(view) + ((ViewGroup.MarginLayoutParams) qVar).bottomMargin, pVarE.j0(), pVarE.X() - pVarE.e0(), i);
    }

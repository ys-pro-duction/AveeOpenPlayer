...
public class d {
    ...
    public final c.AbstractC0033c e;
    ...
    public class a extends a.AbstractBinderC0030a {
        ...
        public void m0(String[] strArr) {
            d.this.g.execute(new RunnableC0034a(strArr));
        }
    }
    ...
    public class f extends c.AbstractC0033c {
        ...
        public void b(Set set) {
            ...
            try {
                ...
                androidx.room.b bVar = dVar.f;
                if (bVar != null) {
                    bVar.E2(dVar.c, (String[]) set.toArray(new String[0]));
                }
            } catch (RemoteException unused) {
            }
        }

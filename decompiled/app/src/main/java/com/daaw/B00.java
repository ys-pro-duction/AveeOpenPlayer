...
public abstract class B00 {
    ...
    public static final int[] b = {1, 10, 100, 1000, 10000, 100000, UtilsKt.MICROS_MULTIPLIER, 10000000, 100000000, 1000000000};
    ...
    public static int a(int i, int i2, RoundingMode roundingMode) {
        AbstractC7785qy0.n(roundingMode);
        if (i2 == 0) {
    ...
    public static int d(int i, RoundingMode roundingMode) {
        AbstractC8540th0.b("x", i);
        switch (a.a[roundingMode.ordinal()]) {
            case 1:
                AbstractC8540th0.c(b(i));
                break;
            case 2:
            case 3:
                break;

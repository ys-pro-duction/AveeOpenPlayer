...
/* JADX INFO: renamed from: com.daaw.a6, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC3062a6 {
    public static final void a(Matrix matrix, float[] fArr) {
        G10.g(matrix, "$this$setFrom");
        G10.g(fArr, "matrix");
        float f = fArr[2];
        if (f == 0.0f) {
            float f2 = fArr[6];

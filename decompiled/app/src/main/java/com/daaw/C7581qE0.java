...
public class C7581qE0 {
    ...
    public void a(int i, float f) {
        ...
        float f2 = this.d;
        float fMax = Math.max(0.0f, Math.min(f - f2, this.e - f2));
        this.j = Math.max(this.h, fMax);
        this.h += fMax;
    }
    ...
    public void g(int i) {
        ...
        float f3 = this.d;
        this.k = f2 - f3;
        this.i = Math.max((f2 - f3) * ((r4 - this.f) + 1), 1.0E-4f);
    }

...
/* JADX INFO: renamed from: com.daaw.r2, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes.dex */
public class C7802r2 implements HZ0 {
    public final int a;
    public final int b;
    public final int c;
    ...
    public C7802r2(Context context, int i, int i2, int i3, int i4, CharSequence charSequence) {
        this.l = context;
        this.a = i2;
        this.b = i;
        this.c = i4;
    ...
    public MenuItem setIcon(int i) {
        this.k = AbstractC9438ws.e(this.l, i);
        c();
        return this;
    }

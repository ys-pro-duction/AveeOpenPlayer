...
public abstract class J70 {
    ...
    public static boolean b(Activity activity, KeyEvent keyEvent) {
        ...
        if (AbstractC2317Td1.j(decorView, keyEvent)) {
            return true;
        }
    ...
    public static boolean d(View view, KeyEvent keyEvent) {
        return AbstractC2317Td1.k(view, keyEvent);
    }
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return Build.VERSION.SDK_INT >= 28 ? aVar.s(keyEvent) : callback instanceof Activity ? b((Activity) callback, keyEvent) : callback instanceof Dialog ? c((Dialog) callback, keyEvent) : (view != null && AbstractC2317Td1.j(view, keyEvent)) || aVar.s(keyEvent);
    }

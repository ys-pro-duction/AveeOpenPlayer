...
public abstract class GE {
    ...
    public static float b(int i, int i2) {
        return 0.54f - (((float) Math.cos((((double) i) * 6.283185307179586d) / ((double) (i2 - 1)))) * 0.46f);
    }

    public static float c(int i, int i2) {
        return (1.0f - ((float) Math.cos((((double) i) * 6.283185307179586d) / ((double) (i2 - 1))))) * 0.5f;
    }

    public static float d(int i, int i2, float f) {
        float f2 = ((i * 2.0f) / i2) - 1.0f;
        float f3 = f * 3.1415927f;
        return a(((float) Math.sqrt(1.0f - (f2 * f2))) * f3) / a(f3);
    }
}

...
public class C6811nV extends AbstractC8524te {
    public final ImageView[] C;
    public final View[] D;
    public final int E;
    public final List F;

    public C6811nV(Context context, ViewGroup viewGroup) {
        super(AbstractC1765Ob1.p(context).inflate(AbstractC9815yD0.n0, viewGroup, false), false);
    ...
    public void Q(final NW nw, int i) {
        ...
        NW.b bVarW = nw.w();
        if (bVarW != null) {
            bVarW.g(new C10217zg1.a() { // from class: com.daaw.hV
        ...
        this.D[0].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.iV
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                nw.l(0);
            }
        });
        this.D[1].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.jV
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                nw.l(1);
            }
        });
        this.D[2].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.kV
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AbstractC8524te.x.a(view);
            }
        });
        this.D[3].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.lV
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AbstractC8524te.z.a(115, view);
            }
        });
        this.D[4].setOnClickListener(new View.OnClickListener() { // from class: com.daaw.mV
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {

...
public abstract class De3 {
    ...
    public static C5171he3 a(Class cls) {
        String str;
        ClassLoader classLoader = De3.class.getClassLoader();
        if (cls.equals(C5171he3.class)) {
            str = b;
        } else {
            if (!cls.getPackage().equals(De3.class.getPackage())) {
        ...
        try {
            ...
            Iterator it = ServiceLoader.load(De3.class, classLoader).iterator();
            ...
            if (arrayList.size() == 1) {
                return (C5171he3) arrayList.get(0);
            }
            if (arrayList.size() == 0) {
                return null;
            }
            try {
                return (C5171he3) cls.getMethod("combine", Collection.class).invoke(null, arrayList);

...
/* JADX INFO: renamed from: com.daaw.ti3, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public abstract class AbstractC8548ti3 {
    public static final AbstractC6875ni3 a;

    static {
        if (AbstractC5750ji3.C() && AbstractC5750ji3.D()) {
            int i = Ac3.a;
        }
        a = new C7433pi3();
    }
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i3) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i7 > i3 - 3) {
                    ...
                    throw new C7990ri3(i6 - 1, length);
                }

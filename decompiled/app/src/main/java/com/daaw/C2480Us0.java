...
public final class C2480Us0 {
    ...
    public final void a() {
        int i;
        int i2 = this.b;
        AbstractC7115ob.f(i2 >= 0 && (i2 < (i = this.d) || (i2 == i && this.c == 0)));
    }
    ...
    public C2480Us0(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C2480Us0(byte[] bArr, int i) {
        this.a = bArr;
        this.d = i;
    }
}

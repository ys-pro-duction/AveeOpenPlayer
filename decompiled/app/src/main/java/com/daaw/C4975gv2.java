...
public final class C4975gv2 extends AbstractC3653cD1 implements RandomAccess {
    public static final C4975gv2 E = new C4975gv2(new Object[0], 0, false);
    public Object[] C;
    public int D;

    public C4975gv2(Object[] objArr, int i, boolean z) {
        super(z);
        this.C = objArr;
        this.D = i;
    }

    public static C4975gv2 m() {
        return E;
    }
    ...
    public final /* bridge */ /* synthetic */ M72 f(int i) {
        if (i >= this.D) {
            return new C4975gv2(Arrays.copyOf(this.C, i), this.D, true);
        }

...
/* JADX INFO: renamed from: com.daaw.cb1, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public abstract class AbstractC3750cb1 {
    ...
    */
    public static int g(int r6, byte[] r7, int r8, int r9) {
        ...
        L86:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.daaw.AbstractC3750cb1.g(int, byte[], int, int):int");
    }

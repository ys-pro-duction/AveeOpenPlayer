...
public final class C4960gs1 extends SA1 {
    ...
    public C4960gs1(zzaw zzawVar, Context context, zzq zzqVar, String str, SL1 sl1) {
        this.f = zzawVar;
        this.b = context;
        this.c = zzqVar;
        this.d = str;
    ...
    public final /* bridge */ /* synthetic */ Object b(zzce zzceVar) {
        return zzceVar.zzd(BinderC7744qp0.Z2(this.b), this.c, this.d, this.e, 233702000);
    }

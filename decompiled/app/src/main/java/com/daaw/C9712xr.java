...
/* JADX INFO: renamed from: com.daaw.xr, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes.dex */
public class C9712xr extends AbstractC1943Pu {
    public AbstractC7524q2[] E;

    /* JADX INFO: renamed from: com.daaw.xr$a */
    public class a extends AbstractC4157e20.g.a {
        ...
        public void c(Object obj, List list) {
            C9712xr.Y(C9712xr.this, "" + ((g) obj).a, list);
        }
    }

    /* JADX INFO: renamed from: com.daaw.xr$b */
    ...
    /* JADX INFO: renamed from: com.daaw.xr$c */
    ...
    /* JADX INFO: renamed from: com.daaw.xr$d */
    ...
    /* JADX INFO: renamed from: com.daaw.xr$e */
    ...
    /* JADX INFO: renamed from: com.daaw.xr$f */
    public static class f implements FQ {
        ...
        public C2138Rl0 a(AbstractC9991yr abstractC9991yr) {
            return C2138Rl0.w(C9712xr.Y(abstractC9991yr, this.a, null), null);
        }
    }

    /* JADX INFO: renamed from: com.daaw.xr$g */
    ...
    public C9712xr(Context context, String str, String str2, int i, int i2) {
    ...
    public static List Y(AbstractC9991yr abstractC9991yr, String str, List list) {
        ...
        Cursor cursorE = AbstractC2022Qi0.e(contextH.getContentResolver(), uri, new String[]{"_id", "_data"}, "artist_id=?", new String[]{str}, strC);
        if (cursorE == null) {
            return new ArrayList();
        }
    ...
    public static B61 a0(Context context, InterfaceC5694jX interfaceC5694jX, int i) {
        ...
        return new B61(AbstractC2022Qi0.f(contentResolver, MediaStore.Audio.Artists.EXTERNAL_CONTENT_URI, new String[]{"_id", "artist", "number_of_tracks", "number_of_albums"}, str, strArr, null), str2);
    }

    @Override // com.daaw.AbstractC9991yr
    public C1773Od1 E(Context context, int i) {
        return new C1773Od1(new MU(this, this, 8, 1), this);
    }
    ...
    public void Z(Cursor cursor, int i, C6363ls c6363ls) {
        ...
        c6363ls.e0(c6363ls.A.getResources().getQuantityString(FD0.a, cursor.getInt(3), Integer.valueOf(cursor.getInt(3))));
        c6363ls.f0(0);
    ...
    public C1773Od1 d(Context context, String str) {
        String strA;
        Cursor cursorE = AbstractC2022Qi0.e(context.getContentResolver(), MediaStore.Audio.Artists.EXTERNAL_CONTENT_URI, new String[]{"_id", "artist"}, "_id=?", new String[]{str}, null);
        if (cursorE != null) {
            cursorE.moveToFirst();
    ...
    public void x(Context context, String[] strArr, InterfaceC5694jX[] interfaceC5694jXArr) {
        strArr[0] = context.getResources().getString(JD0.x2);

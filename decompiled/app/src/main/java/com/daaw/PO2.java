...
public abstract class PO2 {
    public static final AbstractC4540fN2 a;

    static {
        if (AbstractC4247eM2.C() && AbstractC4247eM2.D()) {
            int i = ID1.a;
        }
        a = new JN2();
    }
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i3) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i7 > i3 - 3) {
                    ...
                    throw new C6786nO2(i6 - 1, length);
                }

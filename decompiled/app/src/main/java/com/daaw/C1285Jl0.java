...
public final class C1285Jl0 {
    public static final String[] h = {"audio/mpeg-L1", "audio/mpeg-L2", "audio/mpeg"};
    public static final int[] i = {44100, 48000, 32000};
    public static final int[] j = {32, 64, 96, 128, 160, 192, 224, PSKKeyManager.MAX_KEY_LENGTH_BYTES, 288, 320, 352, 384, 416, 448};
    public static final int[] k = {32, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, 192, 224, PSKKeyManager.MAX_KEY_LENGTH_BYTES};
    public static final int[] l = {32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, PSKKeyManager.MAX_KEY_LENGTH_BYTES, 320, 384};
    public static final int[] m = {32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, PSKKeyManager.MAX_KEY_LENGTH_BYTES, 320};
    ...
    public static boolean b(int i2, C1285Jl0 c1285Jl0) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        c1285Jl0.c(i3, h[3 - i4], i8, i11, ((i2 >> 6) & 3) == 3 ? 1 : 2, i7 * 1000, i9);
        return true;
    }

...
public abstract class P53 {
    ...
    public static String g(ByteBuffer byteBuffer, int i, int i2) {
        ...
        if (byteBuffer.hasArray()) {
            return m53.b(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        return byteBuffer.isDirect() ? M53.d(byteBuffer, i, i2) : M53.d(byteBuffer, i, i2);
    }

...
public final class BillingWrapper$acknowledge$1 extends AbstractC4192e90 implements NQ {
    final /* synthetic */ InterfaceC3429bR $onAcknowledged;
    ...
    public static final class AnonymousClass1 extends AbstractC4192e90 implements NQ {
        ...
        public AnonymousClass1(String str, InterfaceC3429bR interfaceC3429bR) {
            super(1);
            this.$token = str;
            this.$onAcknowledged = interfaceC3429bR;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void invoke$lambda$0(InterfaceC3429bR interfaceC3429bR, String str, com.android.billingclient.api.d dVar) {
            G10.g(interfaceC3429bR, "$onAcknowledged");
            G10.g(str, "$token");
        ...
        public final void invoke(com.android.billingclient.api.a aVar) {
            ...
            C5003h2 c5003h2A = C5003h2.b().b(this.$token).a();
            final InterfaceC3429bR interfaceC3429bR = this.$onAcknowledged;
            final String str = this.$token;
            aVar.a(c5003h2A, new InterfaceC5282i2() { // from class: com.revenuecat.purchases.google.a
                @Override // com.daaw.InterfaceC5282i2
                public final void b(com.android.billingclient.api.d dVar) {
                    BillingWrapper$acknowledge$1.AnonymousClass1.invoke$lambda$0(interfaceC3429bR, str, dVar);
                }
            });
        }
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BillingWrapper$acknowledge$1(BillingWrapper billingWrapper, String str, InterfaceC3429bR interfaceC3429bR) {
        super(1);

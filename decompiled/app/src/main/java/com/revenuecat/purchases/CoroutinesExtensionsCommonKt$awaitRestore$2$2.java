...
public final class CoroutinesExtensionsCommonKt$awaitRestore$2$2 extends AbstractC4192e90 implements NQ {
    final /* synthetic */ InterfaceC1416Ks $continuation;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoroutinesExtensionsCommonKt$awaitRestore$2$2(InterfaceC1416Ks interfaceC1416Ks) {
        super(1);
    ...
    public final void invoke(CustomerInfo customerInfo) {
        ...
        this.$continuation.x(AbstractC4512fJ0.a(customerInfo));
    }
}

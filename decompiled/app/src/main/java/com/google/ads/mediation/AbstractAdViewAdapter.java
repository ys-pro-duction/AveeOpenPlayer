...
public abstract class AbstractAdViewAdapter implements MediationBannerAdapter, MediationInterstitialAdapter, MediationNativeAdapter, OnImmersiveModeUpdatedListener, zza {
    ...
    public void requestBannerAd(Context context, MediationBannerListener mediationBannerListener, Bundle bundle, AdSize adSize, MediationAdRequest mediationAdRequest, Bundle bundle2) {
        ...
        this.mAdView.setAdListener(new KC1(this, mediationBannerListener));
    ...
    public void requestNativeAd(Context context, MediationNativeListener mediationNativeListener, Bundle bundle, NativeMediationAdRequest nativeMediationAdRequest, Bundle bundle2) {
        C4662fo2 c4662fo2 = new C4662fo2(this, mediationNativeListener);
        AdLoader.Builder builderWithAdListener = newAdLoader(context, bundle.getString(AD_UNIT_ID_PARAMETER)).withAdListener(c4662fo2);
        ...
        if (nativeMediationAdRequest.isUnifiedNativeAdRequested()) {
            builderWithAdListener.forUnifiedNativeAd(c4662fo2);
        }
        if (nativeMediationAdRequest.zzb()) {
            for (String str : nativeMediationAdRequest.zza().keySet()) {
                builderWithAdListener.forCustomTemplateAd(str, c4662fo2, true != ((Boolean) nativeMediationAdRequest.zza().get(str)).booleanValue() ? null : c4662fo2);
            }
        }

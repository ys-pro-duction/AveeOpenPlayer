...
public final class C10383a implements Spliterator {
    ...
    public C10383a(java.util.List list) {
        this.a = list;
        this.b = 0;
        this.c = -1;
    }

    public C10383a(C10383a c10383a, int i, int i2) {
        this.a = c10383a.a;
        this.b = i;
        this.c = i2;
    }

...
public final class C10480p3 extends AbstractC10485q3 implements Spliterator {
    ...
    public C10480p3(Spliterator spliterator, long j, long j2) {
    ...
    public final Spliterator a(Spliterator spliterator, long j, long j2, long j3, long j4) {
        return new C10480p3(spliterator, j, j2, j3, j4);
    }
    ...
    public final boolean tryAdvance(Consumer consumer) {
        ...
        while (true) {
            ...
            this.c.tryAdvance(new C10402a0(18));
            this.d++;
        }
        if (j >= this.e) {
            return false;
    ...
    public final void forEachRemaining(Consumer consumer) {
        ...
        while (j2 > this.d) {
            this.c.tryAdvance(new C10402a0(19));
            this.d++;
        }
        while (this.d < this.e) {

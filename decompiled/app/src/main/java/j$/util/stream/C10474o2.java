...
public final class C10474o2 extends AbstractC10432g0 {
    public final /* synthetic */ long m;
    public final /* synthetic */ long n;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C10474o2(AbstractC10437h0 abstractC10437h0, int i, long j, long j2) {
        super(abstractC10437h0, i, 0);
        this.m = j;
        this.n = j2;
    }
    ...
    public final Spliterator K(AbstractC10401a abstractC10401a, Spliterator spliterator) {
        ...
        if (jF > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.Y y = (j$.util.Y) abstractC10401a.S(spliterator);
            long j2 = this.m;
            return new C10470n3(y, j2, AbstractC10497t1.A(j2, j));
        }
        if (V2.ORDERED.r(abstractC10401a.f)) {
            return ((E0) new C10493s2(this, abstractC10401a, spliterator, new C10402a0(16), this.m, this.n).invoke()).spliterator();
        }
        j$.util.Y y2 = (j$.util.Y) abstractC10401a.S(spliterator);
        long j3 = this.m;
        if (j3 <= jF) {
            long jMin = jF - j3;
            if (j >= 0) {
    ...
    public final E0 J(AbstractC10401a abstractC10401a, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jF <= 0 || !spliterator.hasCharacteristics(16384)) {
            if (!V2.ORDERED.r(abstractC10401a.f)) {
                ...
                return AbstractC10497t1.E(this, new C10499t3(y, j, jMin), true);
            }
        ...
        return AbstractC10497t1.E(abstractC10401a, AbstractC10497t1.y(abstractC10401a2.H(), spliterator, this.m, this.n), true);
    }

    @Override // j$.util.stream.AbstractC10401a
    public final InterfaceC10444i2 M(int i, InterfaceC10444i2 interfaceC10444i2) {
        return new C10469n2(this, interfaceC10444i2);
    }
}

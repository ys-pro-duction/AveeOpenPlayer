...
public final class i implements e {
    ...
    public final boolean k(s sVar, StringBuilder sb) {
        Long lA = sVar.a(ChronoField.OFFSET_SECONDS);
        boolean z = false;
        if (lA == null) {
            return false;
        }
    ...
    public static void a(boolean z, int i, StringBuilder sb) {
        sb.append(z ? Constants.SUBS_ID_BASE_PLAN_ID_SEPARATOR : "");
    ...
    public final int n(p pVar, CharSequence charSequence, int i) {
        ...
        if (length2 == 0) {
            if (i == length) {
                return pVar.f(ChronoField.OFFSET_SECONDS, 0L, i, i);
            }
            ...
            if (pVar.g(charSequence2, i, this.a, 0, length2)) {
                return pVar.f(ChronoField.OFFSET_SECONDS, 0L, i, i + length2);
            }
        }
        ...
        if (cCharAt == '+' || cCharAt == '-') {
            ...
            if (i9 > 0) {
                ...
                return pVar.f(ChronoField.OFFSET_SECONDS, ((((long) i2) * 60) + (((long) i10) * 3600) + ((long) i3)) * ((long) i6), i, i9);
            }
        }
        return length2 == 0 ? pVar.f(ChronoField.OFFSET_SECONDS, 0L, i, i) : ~i;
    }

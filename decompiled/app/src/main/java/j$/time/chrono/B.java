...
public final class B extends AbstractC10377d {
    ...
    public final ValueRange r(TemporalField temporalField) {
        ...
        if (i != 4) {
            return z.c.E(chronoField);
        }
        ValueRange valueRange = ChronoField.YEAR.c;
        return ValueRange.f(1L, P() <= 0 ? (-valueRange.getMinimum()) + 1912 : valueRange.getMaximum() - 1911);
    }
    ...
    */
    public final j$.time.chrono.B d(long r9, j$.time.temporal.TemporalField r11) {
        /*
            r8 = this;
        ...
        L10:
            ...
            goto L60
        L27:
            j$.time.chrono.z r11 = j$.time.chrono.z.c
        ...
        L98:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.time.chrono.B.d(long, j$.time.temporal.TemporalField):j$.time.chrono.B");
    }

    @Override // j$.time.chrono.AbstractC10377d, j$.time.chrono.InterfaceC10375b
    /* JADX INFO: renamed from: j */
    public final InterfaceC10375b q(TemporalAdjuster temporalAdjuster) {
        return (B) super.q(temporalAdjuster);
    }

    @Override // j$.time.chrono.AbstractC10377d, j$.time.temporal.k
    public final j$.time.temporal.k q(LocalDate localDate) {
        return (B) super.q(localDate);
    }

...
public final class ResponseInfo {
    ...
    public ResponseInfo(zzdn zzdnVar) {
        ...
        if (zzdnVar != null) {
            try {
                ...
                AbstractC4274eT1.zzh("Could not forward getAdapterResponseInfo to ResponseInfo.", e);
            }
        }
        ...
        try {
            ...
            AbstractC4274eT1.zzh("Could not forward getLoadedAdapterResponse to ResponseInfo.", e2);
        }
    }
    ...
    public String getMediationAdapterClassName() {
        try {
            ...
            AbstractC4274eT1.zzh("Could not forward getMediationAdapterClassName to ResponseInfo.", e);
            return null;
        }
    }
    ...
    public Bundle getResponseExtras() {
        try {
            ...
            AbstractC4274eT1.zzh("Could not forward getResponseExtras to ResponseInfo.", e);
        }
        return new Bundle();
    }
    ...
    public String getResponseId() {
        try {
            ...
            AbstractC4274eT1.zzh("Could not forward getResponseId to ResponseInfo.", e);
            return null;
        }
    }
    ...
    public final JSONObject zzd() throws JSONException {
        ...
        if (responseExtras != null) {
            jSONObject.put("Response Extras", zzay.zzb().l(responseExtras));
        }
        return jSONObject;
    }
}

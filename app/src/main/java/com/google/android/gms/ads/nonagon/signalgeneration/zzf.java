...
public final class zzf {
    public static void a(C1590Mj2 c1590Mj2, C0542Cj2 c0542Cj2, String str, Pair... pairArr) {
        Map mapC = c0542Cj2 == null ? c1590Mj2.c() : c0542Cj2.a();
        b(mapC, "action", str);
        for (Pair pair : pairArr) {
            b(mapC, (String) pair.first, (String) pair.second);
        }
        c1590Mj2.f(mapC);
    }
    ...
    */
    ...
    public static void zzc(final C1590Mj2 c1590Mj2, final C0542Cj2 c0542Cj2, final String str, final Pair... pairArr) {
        if (((Boolean) zzba.zzc().b(AbstractC9820yE1.W6)).booleanValue()) {
            AbstractC9322wT1.a.execute(new Runnable() { // from class: com.google.android.gms.ads.nonagon.signalgeneration.zze
                @Override // java.lang.Runnable
                public final void run() {
                    zzf.a(c1590Mj2, c0542Cj2, str, pairArr);
                }
            });
        }
    }

    public static int zze(FF2 ff2) {
        if (ff2.q) {
            return 2;
        }
        com.google.android.gms.ads.internal.client.zzl zzlVar = ff2.d;

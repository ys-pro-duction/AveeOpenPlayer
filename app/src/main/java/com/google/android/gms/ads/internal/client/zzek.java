...
public final class zzek extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        Bundle bundle = null;
        try {
            bundle = C6878nj1.a(context).c(context.getPackageName(), 128).metaData;
        } catch (PackageManager.NameNotFoundException e) {
            AbstractC4274eT1.zzh("Failed to load metadata: Package name not found.", e);
        } catch (NullPointerException e2) {
            AbstractC4274eT1.zzh("Failed to load metadata: Null pointer exception.", e2);
        }
        LL1 ll1A = LL1.a();
        if (bundle == null) {
            AbstractC4274eT1.zzg("Metadata was null.");
        } else {
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        if (str != null) {
                            ...
                            AbstractC4274eT1.zze("Publisher provided Google AdMob App ID in manifest: ".concat(str));
                            ...
                            AbstractC4274eT1.zze("The Google Mobile Ads SDK is integrated by ".concat(String.valueOf(str2)));
                        }
        ...
        if (bundle != null) {
            ...
            if (z) {
                AbstractC4274eT1.zze("com.google.android.gms.ads.flag.OPTIMIZE_INITIALIZATION is enabled");
            }
            if (z2) {
                AbstractC4274eT1.zze("com.google.android.gms.ads.flag.OPTIMIZE_AD_LOADING is enabled");
            }
        }

...
public final class CustomerInfo$allPurchasedProductIds$2 extends AbstractC4192e90 implements LQ {
    ...
    public final Set<String> invoke() {
        ...
        ArrayList arrayList = new ArrayList(AbstractC1703Nm.v(nonSubscriptionTransactions, 10));
        Iterator<T> it = nonSubscriptionTransactions.iterator();
        while (it.hasNext()) {
            arrayList.add(((Transaction) it.next()).getProductIdentifier());
        }
        return AbstractC10146zQ0.j(AbstractC2455Um.Q0(arrayList), this.this$0.getAllExpirationDatesByProduct().keySet());
    }
}

...
public final /* data */ class Signature {
    ...
    public static final class Companion {
        ...
        public final Signature fromString$purchases_defaultsRelease(String signature) throws InvalidSignatureSizeException {
            ...
            if (bArrDecode.length == totalSize) {
                G10.f(bArrDecode, "signatureBytes");
    ...
    public enum Component {
        ...
        public final int getStartByte() {
            int i = 0;
            for (Object obj : AbstractC5152hb.n(values(), 0, ordinal())) {
    ...
    public Signature(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5) {
        G10.g(bArr, "intermediateKey");
        G10.g(bArr2, "intermediateKeyExpiration");
        G10.g(bArr3, "intermediateKeySignature");
        G10.g(bArr4, "salt");
        G10.g(bArr5, "payload");
    ...
    public final Signature copy(byte[] intermediateKey, byte[] intermediateKeyExpiration, byte[] intermediateKeySignature, byte[] salt, byte[] payload) {
        G10.g(intermediateKey, "intermediateKey");
        G10.g(intermediateKeyExpiration, "intermediateKeyExpiration");
        G10.g(intermediateKeySignature, "intermediateKeySignature");
        G10.g(salt, "salt");
    ...
    public boolean equals(Object other) {
        ...
        if (!G10.c(Signature.class, other != null ? other.getClass() : null)) {
            return false;
        }
        G10.e(other, "null cannot be cast to non-null type com.revenuecat.purchases.common.verification.Signature");

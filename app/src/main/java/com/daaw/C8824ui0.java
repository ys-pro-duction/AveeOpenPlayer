...
public class C8824ui0 {
    ...
    public C8824ui0(File file, int i) {
        this.b = false;
    ...
    public int a(MediaFormat mediaFormat, String str) {
        AbstractC0441Bk1.a("#####  addTrack: " + str + " trackCount: " + this.c);
        synchronized (this.e) {
            try {
                if (this.b) {
            ...
            if (mediaMuxer != null) {
                if (this.b) {
                    try {
                        ...
                        AbstractC0441Bk1.c("mMuxer stop exception: " + e.getMessage());
                    }
                    try {
                        this.a.release();
                    } catch (Exception e2) {
                        AbstractC0441Bk1.c("mMuxer release exception: " + e2.getMessage());
                    }
                    this.a = null;
                } else {
                    this.a.release();

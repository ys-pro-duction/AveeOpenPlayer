...
/* JADX INFO: renamed from: com.daaw.i20, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public class C5283i20 extends InputStream {
    public Iterator B;
    public ByteBuffer C;
    public int D = 0;
    public int E;
    ...
    public C5283i20(Iterable iterable) {
    ...
    public final boolean a() {
        ...
        if (this.C.hasArray()) {
            ...
            this.G = false;
            this.J = AbstractC3188aa1.k(this.C);
            this.H = null;
        }
        return true;
    }
    ...
    public int read() {
        ...
        int iW = AbstractC3188aa1.w(((long) this.F) + this.J) & 255;
        c(1);
        return iW;
    }

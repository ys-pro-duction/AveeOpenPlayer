...
public abstract class AbstractC0301Ab1 {
    ...
    /* JADX INFO: renamed from: com.daaw.Ab1$a */
    ...
    /* JADX INFO: renamed from: com.daaw.Ab1$b */
    ...
    /* JADX INFO: renamed from: com.daaw.Ab1$c */
    ...
    /* JADX INFO: renamed from: com.daaw.Ab1$d */
    ...
    public static void a(Path path, float f, float f2, float f3) {
        ...
        if (fMin >= length && fMax >= length) {
            fMin = AbstractC9678xk0.f(fMin, length);
            fMax = AbstractC9678xk0.f(fMax, length);
        }
        if (fMin < 0.0f) {
            fMin = AbstractC9678xk0.f(fMin, length);
        }
    ...
    public static void b(Path path, C4178e61 c4178e61) {
        if (c4178e61 == null || c4178e61.l()) {
            return;
        }
        a(path, ((C4248eN) c4178e61.j()).p() / 100.0f, ((C4248eN) c4178e61.f()).p() / 100.0f, ((C4248eN) c4178e61.h()).p() / 360.0f);
    }
    ...
    public static void n(Canvas canvas, RectF rectF, Paint paint, int i) {
        U80.a("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, i);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        U80.b("Utils#saveLayer");
    }
}

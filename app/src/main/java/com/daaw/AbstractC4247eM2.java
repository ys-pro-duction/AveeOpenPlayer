...
/* JADX INFO: renamed from: com.daaw.eM2, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public abstract class AbstractC4247eM2 {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.daaw.AbstractC4247eM2.<clinit>():void");
    }
    ...
    public static void d(Object obj, long j, byte b2) {
        EL2 el2 = d;
        long j2 = (-4) & j;
        int i = el2.a.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        el2.a.putInt(obj, j2, ((255 & b2) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void e(Object obj, long j, byte b2) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        el2.a.putInt(obj, j2, ((255 & b2) << i) | (el2.a.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    public static Unsafe l() {
        try {
            return (Unsafe) AccessController.doPrivileged(new WJ2());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static /* bridge */ /* synthetic */ void m(Throwable th) {
        Logger.getLogger(AbstractC4247eM2.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }

...
/* JADX INFO: renamed from: com.daaw.d53, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public final class C3897d53 extends AbstractC4733g33 implements RandomAccess {
    public static final C3897d53 E = new C3897d53(new Object[0], 0, false);
    public Object[] C;
    public int D;

    public C3897d53(Object[] objArr, int i, boolean z) {
        super(z);
        this.C = objArr;
        this.D = i;
    }

    public static C3897d53 m() {
        return E;
    }
    ...
    public final /* bridge */ /* synthetic */ InterfaceC8095s43 f(int i) {
        if (i >= this.D) {
            return new C3897d53(Arrays.copyOf(this.C, i), this.D, true);
        }

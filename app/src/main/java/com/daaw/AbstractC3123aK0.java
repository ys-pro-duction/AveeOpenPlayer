...
public abstract class AbstractC3123aK0 {
    ...
    /* JADX INFO: renamed from: com.daaw.aK0$b */
    public static final class b extends AbstractC4192e90 implements NQ {
        ...
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public final Boolean invoke(EN en) {
            G10.g(en, "e");
            if (en instanceof C3402bK0) {
                return (Boolean) this.B.invoke(en);
            }
            throw new IllegalStateException("FocusAwareEvent is dispatched to the wrong FocusAwareParent.");
        }
    }

    /* JADX INFO: renamed from: com.daaw.aK0$c */
    ...
    public static final NQ a(NQ nq) {
        return new b(nq);
    }
    ...
    public static final InterfaceC1073Hk0 c(InterfaceC1073Hk0 interfaceC1073Hk0, NQ nq) {
        G10.g(interfaceC1073Hk0, "<this>");
        G10.g(nq, "onRotaryScrollEvent");
        NQ cVar = AbstractC5550j00.c() ? new c(nq) : AbstractC5550j00.a();
        InterfaceC1073Hk0.a aVar = InterfaceC1073Hk0.m;
        return AbstractC5550j00.b(interfaceC1073Hk0, cVar, new FN(a(nq), null, a));
    }
}

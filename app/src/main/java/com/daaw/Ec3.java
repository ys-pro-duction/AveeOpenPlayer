...
public final class Ec3 implements Runnable {
    ...
    public Ec3(C7129od3 c7129od3, zzq zzqVar) {
        this.C = c7129od3;
        this.B = zzqVar;
    }
    ...
    public final void run() {
        ...
        if (interfaceC9167vt2 == null) {
            c7129od3.a.w().n().a("Failed to send consent settings to service");
            return;
        }
        try {
            AbstractC7506py0.l(this.B);
            interfaceC9167vt2.I1(this.B);
            this.C.E();
        } catch (RemoteException e) {
            this.C.a.w().n().b("Failed to send consent settings to the service", e);
        }
    }
}

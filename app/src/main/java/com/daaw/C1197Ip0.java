...
public final class C1197Ip0 implements HostnameVerifier {
    public static final C1197Ip0 a = new C1197Ip0();
    ...
    public final boolean e(String str, X509Certificate x509Certificate) {
        ...
        boolean z = false;
        while (i < size) {
            if (d(lowerCase, (String) listA.get(i))) {
                return true;
            }
            i++;
            z = true;
        }
        if (z || (strB = new EC(x509Certificate.getSubjectX500Principal()).b("cn")) == null) {
            return false;
        }
    ...
    public final boolean f(String str, X509Certificate x509Certificate) {
        ...
        for (int i = 0; i < size; i++) {
            if (str.equalsIgnoreCase((String) listA.get(i))) {
                return true;
            }
        }
        return false;

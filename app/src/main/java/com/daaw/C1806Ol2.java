...
/* JADX INFO: renamed from: com.daaw.Ol2, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes3.dex */
public final class C1806Ol2 {
    ...
    public static final void b(Context context, ViewGroup viewGroup, NativeAd nativeAd) {
        ...
        linearLayout.addView(c(context, resourcesD == null ? "Headline" : resourcesD.getString(R.string.native_headline), "headline_header_tag"));
        View viewD = d(context, BO2.c(nativeAd.getHeadline()), "headline_tag");
        nativeAdView.setHeadlineView(viewD);
        linearLayout.addView(viewD);
        linearLayout.addView(c(context, resourcesD == null ? "Body" : resourcesD.getString(R.string.native_body), "body_header_tag"));
        View viewD2 = d(context, BO2.c(nativeAd.getBody()), "body_tag");
        nativeAdView.setBodyView(viewD2);
        linearLayout.addView(viewD2);
        linearLayout.addView(c(context, resourcesD == null ? "Media View" : resourcesD.getString(R.string.native_media_view), "media_view_header_tag"));

...
public abstract class AbstractC6280lb1 {
    ...
    /* JADX INFO: renamed from: com.daaw.lb1$a */
    ...
    public static int G(String str) {
        String strA0 = a0(str);
        if (strA0.endsWith(".mpd")) {
            return 0;
        }
        if (strA0.endsWith(".m3u8")) {
            return 2;
        }
        return strA0.matches(".*\\.ism(l)?(/manifest(\\(.+\\))?)?") ? 1 : 3;
    }
    ...
    public static Object[] N(Object[] objArr, int i2) {
        AbstractC7115ob.a(i2 <= objArr.length);
        return Arrays.copyOf(objArr, i2);
    }

    public static long O(String str) throws C3000Zs0 {
        Matcher matcher = f.matcher(str);
        if (!matcher.matches()) {
            throw new C3000Zs0("Invalid date/time format: " + str);
        }
        int i2 = 0;
    ...
    */
    public static long S(long r7, com.daaw.DO0 r9, long r10, long r12) {
        /*
            com.daaw.DO0 r0 = com.daaw.DO0.c
        ...
        L4f:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.daaw.AbstractC6280lb1.S(long, com.daaw.DO0, long, long):long");
    }
    ...
    public static long[] U(List list, long j, long j2) {
        int size = list.size();
    ...
    public static int d(List list, Object obj, boolean z, boolean z2) {
        int i2;
        int i3;
        int iBinarySearch = Collections.binarySearch(list, obj);
        if (iBinarySearch < 0) {
            i3 = -(iBinarySearch + 2);
        } else {
            while (true) {
                i2 = iBinarySearch - 1;
                if (i2 < 0 || ((Comparable) list.get(i2)).compareTo(obj) != 0) {
                    break;
                }
                iBinarySearch = i2;
            }
    ...
    public static void h(InterfaceC2595Vv interfaceC2595Vv) {
    ...
    public static String s(String str, int i2) {
        ...
        String[] strArrW = W(str.trim(), "(\\s*,\\s*)");
        StringBuilder sb = new StringBuilder();
        for (String str2 : strArrW) {
            if (i2 == AbstractC8834uk0.i(str2)) {
                if (sb.length() > 0) {
                    sb.append(",");
                }
                sb.append(str2);

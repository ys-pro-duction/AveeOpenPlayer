...
public class ServiceConnectionC4330eg implements ServiceConnection {
    public boolean a = false;
    public final BlockingQueue b = new LinkedBlockingQueue();

    public IBinder a(long j, TimeUnit timeUnit) throws TimeoutException {
        AbstractC7506py0.k("BlockingServiceConnection.getServiceWithTimeout() called on main thread");
        if (this.a) {

...
public final class C10532v implements DoubleConsumer {
    public double a;
    public double b;
    private long count;
    private double sum;
    ...
    public final void b(C10532v c10532v) {
        this.count += c10532v.count;
        this.b += c10532v.b;
        c(c10532v.sum);
        c(c10532v.a);
        this.min = Math.min(this.min, c10532v.min);
        this.max = Math.max(this.max, c10532v.max);
    }
    ...
    public final String toString() {
        double d;
        String simpleName = C10532v.class.getSimpleName();
